// Source: ../portal.public-search-page.v2.schema.json
...
/**
 * Public lexical/browse page preserving every matching state-100/200 version. Items and keyset cursors use exact kind/id/version identity; grouping is presentation only.
 */
export interface TianGongPortalPublicSearchPageV2 {
  schemaVersion: "portal.public-search-page.v2";
  kind: "process" | "flow";
  /**
...
/**
 * This interface was referenced by `TianGongPortalPublicSearchPageV2`'s JSON-Schema
